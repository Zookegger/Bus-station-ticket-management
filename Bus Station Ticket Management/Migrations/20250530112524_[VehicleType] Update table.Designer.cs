...
namespace Bus_Station_Ticket_Management.Migrations
{
    ...
    [Migration("20250530112524_[VehicleType] Update table")]
    partial class VehicleTypeUpdatetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bus_Station_Ticket_Management.Models.Payment", b =>
                {
                    ...
                    b.Property<string>("VnPaymentTransactionNo")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Bus_Station_Ticket_Management.Models.VehicleType", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("RowsPerFloor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.PrimitiveCollection<string>("SeatsPerFloor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Bus_Station_Ticket_Management.Models.Driver", b =>
                {
                    b.HasOne("Bus_Station_Ticket_Management.Models.ApplicationUser", "Account")
                        .WithMany()
                        .HasForeignKey("Id")
            ...
            modelBuilder.Entity("Bus_Station_Ticket_Management.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("Bus_Station_Ticket_Management.Models.Payment", "Payment")
                        .WithMany("Tickets")
